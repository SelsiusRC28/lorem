    ...
    <div class="web">
        <div class="nav">
            <Link href="/" class="link">
                <h1 class="titulo">
                    <span class="titulo-green">Lorem</span> Ipsum
                </h1>
            </Link>

            <div class="user-content" v-if="$page.props.user">
                <Link href="home" class="p"> {{ $page.props.user.email }}</Link>
            </div>
            <div v-else class="auth-content">
                <Link href="login"> <button class="login">Login</button> </Link>
                <Link href="register"> <button class="register">Register</button>  </Link>
            </div>
        </div>
       <div class="ddiv">
            <div id="stars"></div>
        ...
        <div id="title">
            ...
            <p class="p p-title">
                ...
                Expedita commodi ad minus sunt velit illo tempora ex
                voluptatibus necessitatibus nostrum. Omnis, beatae totam? Eum,
                culpa. Provident sunt vero error cum!
            </p>
        </div>
        <div class="contenido">
            ...
            <div class="services">
                <div class="service">
                    <img src="storage/assets/Carding.png" class="service-img">
                    <h3>Checker</h3>
                    <p class="service-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorem, ipsum eligendi quas unde necessitatibus quod sapiente accusamus, ad possimus consequuntur incidunt ab officia aperiam? Provident quaerat ad dolorum culpa cum!</p>
                </div>
                <div class="service">
                </div>
                <div class="service">
